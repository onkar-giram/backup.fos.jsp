...
<html lang="en">
  <head>
    ...
    <title>Sign In- Hotel Flora inn </title>
    ...
    window.onload = function(){
        ...
        var TableNo = ParseURLParameter('tn');
        
        
        if(typeof TableNo !== 'undefined'){
            addTableNumber(TableNo);
        }else{
                window.alert('Table number not found');
 
        }

        function addTableNumber(table_no) {
          var url = "ajax/addTableNumber.jsp?table_no="+table_no;
          var xhttp = new XMLHttpRequest();
          xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
              if(this.responseText = "saved"){
              alert("Table Number Added to Session");}
            }
          };
 ...
 %>	
  ...
  <body id="home">
   ...
   <nav class="black lighten-1" role="navigation">
    <div class="nav-wrapper">
          <a id="logo-container" href="#" class="brand-logo hide-on-med-and-down" style="padding-left: 150px" >Hotel Flora-inn</a>
          <a id="logo-container" href="#" class="brand-logo hide-on-large-only" >Hotel Flora-inn</a>
      <ul class="right hide-on-med-and-down">
        <li><a class="modal-trigger" href="#signIn">Login</a></li>
        <li><a class="modal-trigger" href="#signUp">Sign Up</a></li>        
        <li><a href="forStaff.jsp">For Staff</a></li>
      ...
      <ul class="slides">
        <li>
          ...
          <div class="caption left-align">
            ...
            <a href="#signIn" class="modal-trigger white black-text waves-effect waves-light btn btn-large"
              >Login</a
            >
          </div>
        </li>
        <li>
          ...
          <div class="caption center-align">
            ...
            <a href="#signUp" class="modal-trigger white black-text waves-effect waves-light btn btn-large"
              >Sign Up</a
            >
          </div>
        </li>
  ...
  <div id="signUp" class="modal">
    <div class="modal-content">
        <form><h3 class="center black white-text">Customer Sign up</h3>
	<table>
            <tr>
                <td>
                    First Name
		...
		<td>
                    Email
                        ...
                        <td>				
                    <input class="form-control validate" type="text" title="enter your email address" name="email" id="email" />
		</td>
            </tr>
            <tr>	
		<td>
		...
		<td>				
                ...
                <input class="btn black white-text" type="submit" name="submit" value="Sign-Up"/>	
	</form>	
      </div>
  </div>
  ...
  <div id="signIn" class="modal">
    <div class="modal-content">        
        <form class="l6 m8 s8 offset-l3 offset-m2 offset-s2 lighten-2" action="login.jsp" method="post"><h3 class="center-align black white-text">Customer Login</h3>
            <table>
                <tr>
                    <td>
                        Mobile Number:
                    ...
                    <td>
                        <input type="tel" id='cMobileNo' name="cMobileNo" class="form-control validate input-field" maxlength="10" title="Enter 10 digits only" pattern="[1-9]{1}[0-9]{9}" required/> 
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type='password' id='cPassword' name="cPassword" class="form-control validate input-field" title="Enter valid password" required/>
                    </td>
                </tr>
            </table><input type="submit" value="Login" name='submit' class="btn black white-text"/>
        </form>
        <a href="#forgotPassword" class="modal-trigger center">Forgot Password</a>
     </div>
  </div>
		...
		<tr>
			...
			Email
                ...
                <tr>
                    ...
                    <td>
                                <textarea type="text" class=" materialize-textarea validate form-control" id="inquiry" name="inquiry" ></textarea>     
                    </td>
                </tr>
...
<div id="forgotPassword" class="modal" >
    <div class="modal-content">
        <h3 class="black white-text">Forgot Password</h3>
        <form>
            <table>
                <tr>
                    <td>
                    ...
                    <td>
                        <input class="form-control" type="tel" name="mobileNo" id="fMobileNo" maxlength="10" title="Enter 10 digits only" pattern="[1-9]{1}[0-9]{9}" required/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type='password' id='fPassword' name="password" class="form-control validate input-field" title="Enter valid password" required/>
                    </td>                    
                </tr>
                <tr>
                    <td>
		...
		<br>		
		<td colspan="2">
			<input class="btn black white-text" type="submit" name="submit" value="Change Password"/>
		</td>
		</tr>                
            </table>
        </form>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col l3 s12 offset-l1">
            ...
            <ul>
              <li><a class="white-text modal-trigger" href="#signIn">Login</a></li>
              <li><a class="white-text modal-trigger" href="#signUp">Sign Up</a></li>
              <li><a class="white-text" href="forStaff.jsp">For Staffs</a></li>
