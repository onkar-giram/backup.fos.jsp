      ...
      <ul class="slides">
        <li>
          ...
          <div class="caption left-align">
            ...
            <a href="orders.jsp" class="modal-trigger white black-text waves-effect waves-light btn btn-large"
              >View Orders</a
            >
          </div>
        </li>
  ...
  <div id="addAccount" class="modal">
	...
	<table>
		...
		<td>				
                ...
                <input class="btn btn-secondary" type="submit" name="submit" value="Add Account"/>	
	</form>	
      </div>
  </div>
