	...
	if(request.getParameter("submit").equals("Submit")){	
        ...
        if(request.getParameter("submit").equals("Logout")){
            ...
            if(prog == 1){
                ...
                System.out.println("Failure while loging out");
            }
        }
	}
 %>		
    ...
    <nav class="black lighten-1" role="navigation">
      <div class="nav-wrapper">
        ...
        <ul id="nav-mobile" class="sidenav">
                ...
                <li><a href="cart.jsp">Cart</a></li>
                <li><a class="modal-trigger" href="#feedback">Feedback</a></li>
                <li> <a href="#signOut" class="modal-trigger black white-text btn" >Logout</a> </li>
        </ul>
      ...
      <ul class="slides">
        <li>
          ...
          <div class="caption left-align">
            ...
            <a href="foodItems.jsp" class="white black-text waves-effect waves-light btn btn-large"
              >ORDER FOOD</a
            >
          </div>
        </li>
